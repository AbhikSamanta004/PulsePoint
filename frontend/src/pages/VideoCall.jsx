...
const VideoCall = () => {
    ...
    return (
        <div className="flex flex-col h-[85vh] m-5 bg-zinc-950 rounded-2xl overflow-hidden relative shadow-2xl border border-zinc-800">
            {/* Main Video Area */}
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-zinc-400 mt-1 uppercase tracking-widest text-[10px] font-bold">
                                {status === 'Camera Error'
                                    ...
                                    : 'Awaiting Specialist Connection'}
                            </p>
                            {receivingCall && !callAccepted && (
                                <button
                                    onClick={answerCall}
                                    className="mt-6 bg-green-500 hover:bg-green-600 text-white px-10 py-4 rounded-2xl font-bold transition-all shadow-lg shadow-green-900/20 hover:-translate-y-1 active:translate-y-0"
                                >
                                    Accept Consultation
                                </button>
                            )}
