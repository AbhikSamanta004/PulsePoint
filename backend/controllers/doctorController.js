...
// API to get doctor appointments fro doctor pannel
...
// API to get single appointment details for doctor
const getAnyAppointmentDetails = async (req, res) => {
  try {
